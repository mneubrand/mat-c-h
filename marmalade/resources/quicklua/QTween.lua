...
function tweeninst:update(time)
    dbg.assertFuncVarType("number", time)
	...
	-- Tween in progress
	local frac = (time - self.starttime) / self.duration -- 0..1
