...
config = {}
cmdline = ['D:/Programs/Marmalade/6.2/s3e/makefile_builder/mkb.py', 'd:/Projects/match/marmalade/match.mkb', '--non-interactive', '--no-make', '--no-ide', '--buildenv=WEB', '--builddir', 'build_temp', '--use-prebuilt', '--deploy-only']
mkb = 'd:/Projects/match/marmalade/match.mkb'
